...
namespace TopologyAPISampleCode
{
  class Program
  {
    // The original dataset is located in ..\Data.  You can either copy ..\Data\GrandTeton.gdb to the new folder C:\Data
    // or modify the path below.

    static readonly string GRAND_TETON_GDB_FULL_PATH = @"C:\Data\GrandTeton.gdb";
